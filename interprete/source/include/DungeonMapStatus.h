...
class DungeonMapStatus : public MapStatus {
  ...
  public:
    ...
    //!Instancia e inicializa el DungeonMapStatus
    DungeonMapStatus(std::map<int, bool> collectables, std::map<int, bool> doors, std::map<int, bool> puzzles, std::map<int, bool> minibosses, bool bossDefeated, bool gotBossKey, bool gotCompass, bool gotMap, bool gotPowerUp);
