...
bool EngineManager::init()
{
	...
	{
		logger->log(strcat("EngineManager::init() Excepción capturada SFML: ", e.what()));
		return false;
	}
}
...
EngineManager::EngineManager(int screenW, int screenH, int screenBPP, int fps, int gameW, int gameH, int gameScale)
{
	...
	{
		logger->log(strcat("EngineManager::EngineManager(int screenW, int screenH, int screenBPP, int fps, int gameW, int gameH, int gameScale) Excepción capturada SFML: ", e.what()));
	}
