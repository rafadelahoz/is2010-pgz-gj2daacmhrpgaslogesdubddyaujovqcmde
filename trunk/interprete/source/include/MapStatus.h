...
class MapStatus {
  ...
  public:
    ...
    //!Instancia e inicializa el MapStatus 
    MapStatus(std::map<int, bool> collectables, std::map<int, bool> doors, std::map<int, bool> puzzles, std::map<int, bool> minibosses);
