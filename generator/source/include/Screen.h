...
typedef enum entityType { DOOR, BOSSDOOR, ITEM, TILEDENTITY, DMGBLOCKADE, TILEDPUSHABLE, FLOORBUTTON, INSTANTIATOR, DOOR_OPENER, ARENA, TELEPORTATOR, TOOL, DOOR_CLOSER };
