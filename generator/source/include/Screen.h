...
typedef enum entityType { DOOR, BOSSDOOR, ITEM, TILEDENTITY, DMGBLOCKADE, TILEDPUSHABLE, FLOORBUTTON, INSTANCIATOR, DOOR_OPEN_CLOSE, ARENA, TELEPORTATOR, TOOL, DOOR_CLOSER, NOKEYDOOR, FINAL_DOOR,FINAL_ELEMENT };
